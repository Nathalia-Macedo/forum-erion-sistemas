...
// //   const { user, categories, topicos, fetchTopicos, allUsers, fetchAllUsers, deleteUser } = useContext(ForumContext);
...
//     setSelectedPermission(userItem.role);
//     setIsChangingPermission(true);
//   };

//   const confirmChangePermission = async () => {
//     if (userToChangePermission && selectedPermission) {
//       try {
//         await alterarPermissaoUsuario(userToChangePermission.idUsuario, selectedPermission);
//         setIsChangingPermission(false);
//         setUserToChangePermission(null);
//       } catch (error) {
//         console.error('Erro ao alterar permissão do usuário:', error);
//         alert('Falha ao alterar permissão do usuário. Por favor, tente novamente.');
//       }
//     }
//   };
...
//       />
//       <Modal
//         isOpen={isChangingPermission}
//         onClose={() => setIsChangingPermission(false)}
//         onConfirm={confirmChangePermission}
//         title="Alterar Permissão"
//         message={
//           <div>
//             <p>Alterar permissão do usuário {userToChangePermission?.nome}</p>
//             <select
